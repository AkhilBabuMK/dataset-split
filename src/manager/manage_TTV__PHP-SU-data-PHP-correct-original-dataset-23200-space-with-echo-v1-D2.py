...
########################################################################################################################
###### CONFIG PART
DATASET_NAME = 'PHP-correct-original-dataset-with-echo-D2'
DATASET_NAME = 'PHP-correct-original-dataset-with-space_with-renamedVariable-with-echo-D2'
DATASET = '/absolute/path/%s/' % DATASET_NAME #I can used for word2vec like that
NEW_DATASET_NAME = 'PHP-final-preprocessed-data-correct-original-dataset-with-echo-D2'
NEW_DATASET_NAME = 'PHP-final-preprocessed-data-correct-original-dataset-renamedVariable-with-echo-D2'
...
total_trainset, total_testset, total_validset = getNumberOfDataInEachSet(total_in_dataset, withval=True)
