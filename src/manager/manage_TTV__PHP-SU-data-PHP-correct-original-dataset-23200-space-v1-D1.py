...
########################################################################################################################
###### CONFIG PART
DATASET_NAME = 'PHP-correct-original-dataset-with-space_with-renamedVariable'
DATASET = '//absolute/path/%s/' % DATASET_NAME #I can used for word2vec like that
NEW_DATASET_NAME = 'PHP-final-preprocessed-data-correct-original-dataset-renamedVariable-with-HTML-D1'
